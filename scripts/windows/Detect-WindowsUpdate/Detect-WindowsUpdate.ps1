...
#Logging Variables
# CONFIGURATION REQUIRED: To enable Log Analytics logging, replace the placeholder values below
# with your actual Azure Log Analytics Workspace ID and Shared Key.
